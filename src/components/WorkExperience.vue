...
<template>
  <div class="flex flex-col items-center justify-center min-h-screen bg-emerald relative">
    <p class="marker marker-exp uppercase text-emerald-500 font-bold absolute top-0 -right-[12em]">Experiencia</p>
    <h3
    ...
    <div class="flex flex-col mt-10">
      <div class="p-[2px] rounded-xl bg-gradient-to-br from-[#f1ffa0] to-[#00a89d] mb-10 mx-15">
        <div class="bg-[#242424] rounded-[10px] p-10">
      ...
      <div class="p-[2px] rounded-xl bg-gradient-to-br from-[#00a89d] to-[#f1ffa0] mb-10 mx-15">
        <div class="bg-[#242424] rounded-[10px] p-10">
